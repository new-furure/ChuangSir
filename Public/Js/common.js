        ...
        if(data.status==1){
        	if(!data.articleList){
	           ...
	           $.each(data.articleList,function(idx,item){
	          	...
	          	var txt="<dl><dt><img src='/mrchuang/Public/Img/msgUserImg_2.png' /><div class='userConWindow rn ss'><div class='userConWindowBox'><img class='userConImg' src='/mrchuang/Public/Img/msgUserImg_2.png' /><span><b class='rs'>加好友</b><b class='rs'>关注</b><b class='rs'>私信</b></span><p><a class='userConWindowUserName' href='###'>十一的眼泪</a><br /><a href='###'>关注（"+item.user_focus_number+"）</a><strong>|</strong><a href='###'>粉丝（"+item.user_focus_number+"）</a></p><font><a href='###'>个人主页</a><strong>|</strong><a href='###'>个人资料</a><strong>|</strong><a href='###'>项目主页</a></font></div></div></dt><dd><i>"+item.user_name+"发布了</i><em>"+time+"</em><h3>"+item.article_title+"</h3><font>我是动感超人</font><p>"+item.article_content+"<strong>显示更多</strong></p><ul><li class='msgIcon_1 mo clk'>关注问题</li><li class='msgIcon_2 mo clk'>收藏</li><li class='msgIcon_3 mo clk'>赞("+item.article_up_number+")</li><li class='msgIcon_4 mo clk'>踩("+item.article_down_number+")</li><li class='msgIcon_5 mo clk'>评论("+item.article_comment_number+")</li><li class='msgIcon_6 mo clk'>分享</li></ul></dd></dl>";
				txt=$.trim(txt);
	          	$('.msgBox').append(txt);
	          	$('#loadMore').hide();
	          }); 
